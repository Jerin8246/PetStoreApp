...
export default function PetProfile(props) {
  ...
  const buttonFourZeroFiveFourFourSixFourOnClick = async () => {
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(216,221,239,1)"
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonFourZeroFiveFourFourSixFourOnClick();
        }}
        {...getOverrideProps(overrides, "Button4054464")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      >
        ...
        <Button
          ...
          variation="primary"
          children="Update"
          {...getOverrideProps(overrides, "Button4054457")}
        ></Button>
      </Flex>
    </Flex>
  );
