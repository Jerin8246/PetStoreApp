...
export default function NavBar(props) {
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(46,168,15,1)"
    ...
    >
      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 4204060465")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 42040841074")}
        >
          <Text
            fontFamily="Inter"
            fontSize="24px"
            ...
            {...getOverrideProps(overrides, "Jerin")}
          ></Text>
        </Flex>
      </Flex>
    </Flex>
